  ...
  .then((data) => {
    ...
    data.leagues.forEach((league) => {
      // Create league card HTML
        ...
        <td class="align-middle"><button type="button" class="btn btn-dark btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalLiga" data-bs-whatever="${league.name}">Editar</button></td>
        <td class="align-middle"><button type="button" class="btn btn-dark btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalClub" data-bs-whatever="${league.name}">Editar Clubes</button></td>
  ...
  .then((data) => {
    ...
    data.users.forEach((users) => {
      // Create league card HTML
        ...
        <td class="align-middle"><button type="button" class="btn btn-dark btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalUser">Editar User</button></td>
        <td class="align-middle"><a class="btn btn-dark btn-outline-light" onclick="showAlertEliminado()" role="button">Eliminar</a></td>
        </tr>
        `
