                    ...
                    <table class="table table-striped align-middle">
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                            while ($row = mysqli_fetch_assoc($result1)) {
                                ...
                                echo '<td class="align-middle"><button type="button" class="btn btn-primary btn-outline-light" data-bs-toggle="modal" data-bs-target="#modalClub" data-id="' . $row['id_liga'] . '" data-nome="' . $row['nome'] . '">Editar Clubes</button></td>';
